        ...
        (fn [index header]
          (cmp/table-cell
            {:key       (str "table-head-cell-" index)
             :className "rumaterial-table-head-cell"}
                       ...
                       (cmp/table-cell
                         (merge
                           {:key       (str "table-row-cell-" index "-" coll-index)
                            :className "rumaterial-table-row-cell"}
                           (when route
      ...
      (cmp/list-item-text
        (merge
          {:key       (str "list-item-text-" index)
           :className "rumaterial-list-item-text"
           :classes   {:primary   "rumaterial-list-item-text-primary"
                       :secondary "rumaterial-list-item-text-secondary"}
...
(defn table-item-name [primary secondary]
  (html
    [:div
     [:div
      [:span.rumaterial-table-cell-primary primary]]
     [:div
      [:span.rumaterial-table-cell-secondary secondary]]]))
